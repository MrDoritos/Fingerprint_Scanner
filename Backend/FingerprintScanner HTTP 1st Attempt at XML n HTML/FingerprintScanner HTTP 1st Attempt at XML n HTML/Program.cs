...
namespace FingerPrintScannerBackend
{
    class Program
    {
        ...
        static public string[] mainMenuItems = new string[] { "View Keys", "Add Key", "Log In", "Log Out", "Scanner Mode", "Get all fingerRelay data", "Delete All Keys", "Save Database", "Delete users"};
